...
A summary needs an Intelligence model. Open **Settings → Intelligence**, then select Anarlog Cloud or configure another provider.
...
- **Device limit reached:** Remove an unused device or use **Get more slots** in **Settings → Sync → Devices** to add slots to a personal Pro subscription. Your plan and add-ons determine the limit.
...
Email [team@fastrepl.com](mailto:team@fastrepl.com), [join Discord](https://anarlog.so/discord), or [open a GitHub issue](https://github.com/fastrepl/anarlog/issues).
